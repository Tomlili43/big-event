...
public class DemoTest {
  ...
  public void storeImage() throws Exception {
    ...
    String ACCESS_KEY_ID = "LTAI5tB3AoHAEE6fWNZ6VbTX";
    String ACCESS_KEY_SECRET = "LvEsUNYH6SgM0x7WGjluumliVf3J2j";
    // 填写Bucket名称，例如examplebucket。
    String bucketName = "big-event-tom";
    ...
    try {
      ...
      PutObjectRequest putObjectRequest = new PutObjectRequest(bucketName, objectName,
          new FileInputStream("/Users/whitetree/Pictures/002.JPG"));
